...
export class Transaccion {
    ...
    @ManyToOne(() => Usuario, (usuario_1) => usuario_1.transacciones_1, { eager: true, nullable: false })
    @JoinColumn({ name: 'id_usuario_1' })
    usuario_1!: UsuarioType;

    @ManyToOne(() => Usuario, (usuario_2) => usuario_2.transacciones_2, { eager: true, nullable: false })
    ...
    @OneToOne(() => Reporte, (reporte) => reporte.transaccion, { nullable: true })
